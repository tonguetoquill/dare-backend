...
DARE_FRONTEND_URL = os.getenv("DARE_FRONTEND_URL", "http://localhost:5173")
SOCRATIC_BOOKS_FRONTEND_URL = os.getenv("SOCRATIC_BOOKS_FRONTEND_URL", "http://localhost:5174")
DARE_BACKEND_URL = os.getenv("DARE_BACKEND_URL", "http://127.0.0.1:8000")
SOCRATIC_BOOKS_BACKEND_URL = os.getenv("SOCRATIC_BOOKS_BACKEND_URL", "http://127.0.0.1:8001")
