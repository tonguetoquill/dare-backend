...
- Maintainers may rebase on `main` before merging.
...
- Use serializer field separation for read vs. write (see [code-standards.md](code-standards.md) and [serialization.md](serialization.md)).
...
- Suggest, don't demand — `nit:`, `consider:`, `blocking:` prefixes help calibrate.
...
- For larger architectural changes, file an issue with a design sketch *before* writing code.
